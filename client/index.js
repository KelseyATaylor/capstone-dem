...
const deleteDrink = (id) => {
	axios.delete(`${baseURL}/deleteDrink/${id}`).then((res) => {
...
const updateDrink = (id, type) => {
	axios.put(`${baseURL}/updateLikes/${id}`, { type }).then((res) => {
		showDrinks.innerHTML = "";
		displayDrinks(res.data);
	});
};
...
const addDrink = () => {
	...
	axios.post(`${baseURL}/addDrink`, newDrink).then((res) => {
		showDrinks.innerHTML = "";
